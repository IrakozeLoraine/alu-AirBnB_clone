...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_maximum_guests_is_public_class_attribute(self):
        pl = Place()
        self.assertEqual(int, type(Place.maximum_guests))
        self.assertIn("maximum_guests", dir(pl))
        self.assertNotIn("maximum_guests", pl.__dict__)
